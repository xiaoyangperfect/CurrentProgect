...
public class CircleProgress extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < POINTS_COUNT - 1; i ++) {
            ...
            if (p.raduis >= maxRaduis) {
                p.dRaduis = smallReduis;
            }

            if (p.raduis <= minRaduis) {
                p.dRaduis = bigReduis;
            }

            p.raduis = p.raduis + p.dRaduis;
        }
//        calculateMoveingPoint(canvas);
    ...
    private float minRaduis = 0;
    private float bigReduis = 1f/5;
    private float smallReduis = -1f/5;
    protected void initializePoints() {
        maxRaduis = circleRaduis + 8;
        minRaduis = circleRaduis - 8;
        for (int i = 0; i < POINTS_COUNT; i++) {
            ...
            p.color = pointColor;
            if (i == 0) {
                p.raduis = circleRaduis + 0 - 8;
                p.dRaduis = 0;
            } else if (i == 1) {
                p.raduis = circleRaduis + 4 - 8;
                p.dRaduis = smallReduis;
            } else if (i == 2) {
                p.raduis = circleRaduis + 8 - 8;
                p.dRaduis = smallReduis;
            } else if (i == 3) {
                p.raduis = circleRaduis + 12 - 8;
                p.dRaduis = smallReduis;
            } else if (i == 4) {
                p.raduis = circleRaduis + 16 - 8;
                p.dRaduis = 0;
            } else if (i == 5) {
                p.raduis = circleRaduis + 12 - 8;
                p.dRaduis = bigReduis;
