 ...
 */
public class CustomUserFadebackActivity extends BaseActivity {
    ...
    private final String TAG = CustomUserFadebackActivity.class.getName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_custom_user_fadeback);
        mContext = this;
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                if (Reply.TYPE_DEV_REPLY.equals(reply.type)) {
                    ...
                    holder.head = (ImageView) convertView.findViewById(R.id.user_portrait);
                }
            ...
            if (!Reply.TYPE_DEV_REPLY.equals(reply.type)) {
                ...
                ImageOptUtil.imageLoader.displayImage(SharedPreferenceUtil.getAccountSharedPreference(CustomUserFadebackActivity.this).getString(SharedPreferenceUtil.HEADURL, ""),
                        holder.head, ImageOptUtil.image_display_options_circle_no_cache);
            }
    ...
    public void fadebackFinished(View view) {
        CustomUserFadebackActivity.this.finish();
    }
}
